...
The repo contains the first public skill corpus. Production skill bodies are added under `skills/` only when complete.
...
3. If a skill does not exist yet, do not infer product APIs from roadmap text. Use the product repo, public docs, CLI help, or current source code instead.
...
- `skills/using-gosx-ecosystem/SKILL.md`
